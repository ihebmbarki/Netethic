...
class Formation: UIViewController {
...
extension UIViewController {
    ...
    func revealViewController() -> Formation? {
        var viewController: UIViewController? = self

        if viewController != nil && viewController is Formation {
            return viewController! as? Formation
        }
        while (!(viewController is Formation) && viewController?.parent != nil) {
            viewController = viewController?.parent
        }
        if viewController is Formation {
            return viewController as? Formation
        }
        return nil
    }
...
extension Formation: UIGestureRecognizerDelegate {
